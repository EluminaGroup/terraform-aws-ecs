...
```hcl
module "ecs_apps" {
  # source               = "git::https://github.com/EluminaGroup/terraform-aws-ecs.git?ref=0.1.0"
  ...
  certificate_arn      = "${data.aws_acm_certificate.elumina_host.arn}"
...
Apache 2 Licensed. See [LICENSE](https://github.com/EluminaGroup/terraform-aws-ecs/blob/master/LICENSE) for full details.
